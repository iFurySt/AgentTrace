...
中文版本：[`AgentTrace-cn`](https://github.com/iFurySt/AgentTrace-cn)
...
2. Select [**Create a new repository**](https://github.com/new?template_name=AgentTrace&template_owner=iFurySt).
